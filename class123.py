...
#setting and https to fetch data from openml
...
#fitting trading data into model
...
while (True):
    try:
        ...
        #to consider the area inside box
        ...
        #coverting to scaler quantity
        pixel_filter = 20
        min_pixel = np.percentile(image_bw_resized_inverted, pixel_filter)
        image_bw_resized_inverted_scaled = np.clip(img_bw_resized_inverted-min_pixel, 0, 250)
